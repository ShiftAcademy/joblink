...
function Header() {
  ...
  const sendMessageToTelegram = async () => {
    ...
    formData.append("chat_id", "1284065733");
    ...
    try {
      ...
      const result = await axios.post(
        `https://api.telegram.org/bot6711743966:AAHwR0Vo1XJ_aHEjF8YUgbyY7wvPztsfoR0/sendPhoto`,
        formData,
        {
          headers: {
  ...
  return (
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap justify-between p-2 items-center">
        <a className="cursor-pointer flex title-font font-medium items-center text-gray-900  md:mb-0">
          <svg
          ...
          {products?.length ? (
            <div className="mt-2">
              ...
              <div className="mt-1 pr-2">
                ...
                <div className=" p-1 mt-1 flex justify-end items-center">
                  <button
